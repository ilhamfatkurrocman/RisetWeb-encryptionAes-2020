        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <a href="add-toko.php">
                            <button type="button" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp; New Toko</button>
                        </a>
                        <br><br>
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Toko</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $tampil = "SELECT ID_TOKO,NAMA_TOKO,NAMA_PEMILIK_TOKO FROM TOKO";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td scope="col">
                                                    <center>
                                                        <?php echo $data['NAMA_PEMILIK_TOKO']; ?>
                                                    </center>
                                                </td>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="update-toko.php?id=<?php echo $data['ID_TOKO']; ?>">
                                                            <button type="submit" class="btn btn-warning btn-sm" name="aksi">
                                                                <i class="fa fa-dot-circle-o"></i> Edit
                                                            </button>
                                                        </a>
                                                        <a href="delete-toko.php?id=<?php echo $data['ID_TOKO']; ?>">
