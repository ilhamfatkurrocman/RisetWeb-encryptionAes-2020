                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form method="POST" action="registration-process.php?mode=updateCustomer">
                                <div class="card-body card-block">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <input style="text-align:center" type="text" class="form-control" id="nm_customer" name="nm_customer" value="<?php echo $data['nm_customer'] ?>" required="">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class=" col-6">
                                            <label for="example-text-input" class="col-form-label">Address</label>
                                            <input type="text" class="form-control" id="alamat_customer" name="alamat_customer" value="<?php echo $data['alamat_customer'] ?>" required="">
                                        </div>
                                        <div class="col-6">
                                            <label for="example-text-input" class="col-form-label">Telphone</label>
                                            <input type="text" class="form-control" id="telp_customer" name="telp_customer" value="<?php echo $data['telp_customer'] ?>" required="">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <label for="example-text-input" class="col-form-label">Saldo</label>
                                            <input type="text" class="form-control" id="saldo" name="saldo" value="<?php echo $data['saldo'] ?>" required="">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-6">
                                            <label for="example-text-input" class="col-form-label">Username</label>
                                            <input type="text" class="form-control" id="username_customer" name="username_customer" value="<?php echo $data['username_customer'] ?>" required="">
                                        </div>
                                        <div class="col-6">
                                            <label for="example-text-input" class="col-form-label">Password</label>
                                            <input type="password" class="form-control" id="password_customer" name="password_customer" value="<?php echo $data['password_customer'] ?>" required="">
                                        </div>
                                    </div>
                                    <input type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="updateCustomer" value="Update">
                                </div>
                            </form>
                        </div>
                    </div>
