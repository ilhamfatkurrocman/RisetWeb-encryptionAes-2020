                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $tampil = "SELECT ID_ADMIN,NAMA_LENGKAP,ALAMAT_LENGKAP,BAGIAN,TELP_ADMIN,EMAIL_ADMIN,USERNAME,SUBSTRING(PASSWORD, -6) as passwordSTR 
                                        FROM USERSADMIN";
